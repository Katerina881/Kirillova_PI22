...
namespace ZavodConservRestApi.Controllers
{
    ...
    public class MainController : ControllerBase
    {
        ...
        [HttpGet]
        public List<ConservModel> GetConservList() => _Conserv.Read(null)?.Select(rec => Convert(rec)).ToList();
        [HttpGet]
        public ConservModel GetConserv(int ConservId) => Convert(_Conserv.Read(new ConservBindingModel { Id = ConservId })?[0]);
        [HttpGet]
